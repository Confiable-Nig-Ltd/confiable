...
//               alt={`${department?.manager?.firstName || "Unknown"} ${
...
//     name: "Department 1",
//     location: "Shawnton",
//     manager: initialEmployees[7],
//   },
//   {
//     id: 2,
//     name: "Department 2",
//     location: "South Robert",
//     manager: initialEmployees[30],
//   },
//   {
//     id: 3,
//     name: "Department 3",
//     location: "Harrisberg",
//     manager: initialEmployees[19],
//   },
//   {
//     id: 4,
//     name: "Department 4",
//     location: "Michellemouth",
//     manager: initialEmployees[29],
//   },
//   {
//     id: 5,
//     name: "Department 5",
//     location: "Theresaberg",
//     manager: initialEmployees[23],
//   },
// ];
...
//       (emp) =>
//         `${emp.first_name} ${emp.last_name}` === departmentFormData.manager
//     );
//     if (!selectedEmployee) {
...
//                     </span>
//                     <img
//                       key={dept.manager?.employee_id || dept.id} // fallback key if no manager
//                       src={dept.manager?.picture || "/default-avatar.png"}
//                       alt={`${dept.manager?.first_name || "Unknown"} ${
  ...
  <div className="space-y-4">
    ...
    <div className="bg-gray-50 p-4 rounded-lg border">
      <div className="space-y-2 text-sm">
        ...
        <div><span className="font-medium text-gray-700">Manager:</span> {department.manager ? `${department.manager.first_name} ${department.manager.last_name}` : 'None'}</div>
        <div>
          <span className="font-medium text-gray-700">Manager Picture:</span>
          <div className="mt-2">
            <img
...
const RecruitmentDismissalChart = ({ data }) => {
  return (
    <div className="bg-white rounded-2xl shadow-md p-4 w-full">
      <h2 className="text-lg font-semibold mb-4 text-gray-800">
        Monthly Recruitment and Dismissal Trend
      </h2>
      {data.length === 0 ? (
        ...
        <ResponsiveContainer width="100%" height={400}>
          <LineChart
            data={data}
            aria-label="Line chart showing monthly recruitment and dismissal trends"
          >
...
function EmployeeDashboard() {
  ...
  const filteredEmployees = useMemo(
    () =>
      employees.filter((emp) =>
        [emp.first_name, emp.last_name, emp.email, emp.department_id]
          .join(" ")
          .toLowerCase()
          .includes(searchQuery.toLowerCase())
      ),
    ...
    <div className="p-4 bg-indigo-900">
      ...
      {selectedTab === "overview" && (
        <section className="bg-white border rounded-lg p-4 mb-6">
          ...
          <RecruitmentDismissalChart data={recruitmentDismissalData} />
        </section>
      )}
                ...
                >
                  ...
                  <div className="text-sm text-gray-600 mb-4 flex items-center">
                    ...
                    <img
                      ...
                      className="h-12 w-12 rounded-full object-cover mr-2"
                    />
                    {dept.manager ? `${dept.manager.first_name} ${dept.manager.last_name}` : 'None'}
                  </div>
                  <button
                    onClick={() => handleViewDepartmentDetails(dept)}
                    className="bg-blue-600 text-white px-4 py-2 text-sm rounded hover:bg-blue-700"
